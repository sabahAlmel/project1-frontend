...
const Button = ({buttonPressed}) => {
    ...
    <div className={style.buttonsPage}>
        <div className={style.buttons}>
            <div className={`${style.button} ${style[button1Active]}`} onClick={()=>{pressedHandler(1); buttonHandler(1)}}>
                <Monuments />
                <span>Monuments</span>
            </div>
                <div className={`${style.button} ${style[button2Active]}`} onClick={()=>{pressedHandler(2); buttonHandler(2)}}>
                <Monuments />
                <span>Monuments</span>
            </div>
                <div className={`${style.button} ${style[button3Active]}`} onClick={()=>{pressedHandler(3); buttonHandler(3)}}>
                <Monuments />
                <span>Monuments</span>
            </div>
        </div>
